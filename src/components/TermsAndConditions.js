  ...
  return (
    <div>
      ...
      <ul className="terms container mr-1">
        ...
        <li>
          We do not switch ON A/C while traveling upwards in hill station. Also
          while parked or stopped.
        </li>
        <li>
          1 day means 1 Calender day (from midnight 12 to Next Midnight 12).
        </li>
        <li>
          Total Number of Kilometers will be Calculated From Pick point to Drop
